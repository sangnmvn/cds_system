...
$(document).on("click", ".btn-save-company", function () {
  ...
  if ($(".company-name").val().length < 1) {
    $(".company-name").after('<span class="error-company">Please enter Company Name</span>');
  }
  if ($(".company-establishment").val().length < 1) {
    $(".company-establishment").after('<span class="error-company">Please enter Establishment</span>');
  }
  if ($(".company-phone").val().length < 1) {
    $(".company-phone").after('<span class="error-company">Please enter Phone</span>');
  }
  var regEx = /^(?:[a-z0-9!#$%&'*+/=?^_`{|}~-]+(?:\.[a-z0-9!#$%&'*+/=?^_`{|}~-]+)*|"(?:[\x01-\x08\x0b\x0c\x0e-\x1f\x21\x23-\x5b\x5d-\x7f]|\\[\x01-\x09\x0b\x0c\x0e-\x7f])*")@(?:(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?\.)+[a-z0-9](?:[a-z0-9-]*[a-z0-9])?|\[(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?|[a-z0-9-]*[a-z0-9]:(?:[\x01-\x08\x0b\x0c\x0e-\x1f\x21-\x5a\x53-\x7f]|\\[\x01-\x09\x0b\x0c\x0e-\x7f])+)\])/;
  if ($(".company-email").val().length < 1) {
    $(".company-email").after('<span class="error-company">Please enter Email</span>');
  } else {
     var validEmail = regEx.test($(".company-email").val());
    if (!validEmail) {
      $(".company-email").after('<span class="error-company">Please enter a valid email address. For example: abc@domain.com.</span>');
    }
  }
  if ($(".company-address").val().length < 1) {
    $(".company-address").after('<span class="error-company">Please enter Address</span>');
  }
  if ($(".company-ceo").val().length < 1) {
    $(".company-ceo").after('<span class="error-company">Please enter CEO</span>');
  }
  if ($(".company-email-group-staff").val().length > 0) 
  {
     var validEmail = regEx.test($(".company-email-group-staff").val());
    if (!validEmail) {
      $(".company-email-group-staff").after('<span class="error-company">Please enter a valid email address. For example: abc@domain.com.</span>');
    }
  }
  if ($(".company-email-group-hr").val().length > 0) 
  {
    ...
    if (!validEmail) {
      $(".company-email-group-hr").after('<span class="error-company">Please enter a valid email address. For example: abc@domain.com.</span>');
    }
  }
  if ($(".company-email-group-fa").val().length > 0) 
  {
    ...
    if (!validEmail) {
      $(".company-email-group-fa").after('<span class="error-company">Please enter a valid email address. For example: abc@domain.com.</span>');
    }
  }
  if ($(".company-email-group-it").val().length > 0) 
  {
    ...
    if (!validEmail) {
      $(".company-email-group-it").after('<span class="error-company">Please enter a valid email address. For example: abc@domain.com.</span>');
    }
  }
  if ($(".company-email-group-admin").val().length > 0) 
  {
    ...
    if (!validEmail) {
      $(".company-email-group-admin").after('<span class="error-company">Please enter a valid email address. For example: abc@domain.com.</span>');
    }
  }
    ...
    $.ajax({
      ...
      success: function (response) {
        if (response.status == "success") {
          ...
          $(".error-company").remove();
          $(".company-name").after('<span class="error-company">Name already exsit</span>');
        }else {
          fails("Fails!!!.")
        }
      }
...
$(document).on("click", ".btn-save-project", function () {
  ...
  if ($(".project-company-name").val().length < 1) {
    $(".project-company-name").after('<span class="error-project">Please enter Company Name</span>');
  }
  if ($(".project-name").val().length < 1) {
    $(".project-name").after('<span class="error-project">Please enter Project Name</span>');
  }
  if ($(".project-establishment").val().length < 1) {
    $(".project-establishment").after('<span class="error-project">Please enter Establishment</span>');
  }
  if ($(".project-manager").val().length < 1) {
    $(".project-manager").after('<span class="error-project">Please enter Project Manager</span>');
  }
  if ($(".project-email").val().length < 1) {
    $(".project-email").after('<span class="error-project">Please enter Email</span>');
  }else {
    var regEx = /^(?:[a-z0-9!#$%&'*+/=?^_`{|}~-]+(?:\.[a-z0-9!#$%&'*+/=?^_`{|}~-]+)*|"(?:[\x01-\x08\x0b\x0c\x0e-\x1f\x21\x23-\x5b\x5d-\x7f]|\\[\x01-\x09\x0b\x0c\x0e-\x7f])*")@(?:(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?\.)+[a-z0-9](?:[a-z0-9-]*[a-z0-9])?|\[(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?|[a-z0-9-]*[a-z0-9]:(?:[\x01-\x08\x0b\x0c\x0e-\x1f\x21-\x5a\x53-\x7f]|\\[\x01-\x09\x0b\x0c\x0e-\x7f])+)\])/;
    var validEmail = regEx.test($(".project-email").val());
    if (!validEmail) {
      $(".project-email").after('<span class="error-project">Please enter a valid email address. For example: abc@domain.com.</span>');
    }
  }
  if ($(".error-project").length == 0) {
    $.ajax({
      type: "POST",
      url: "/category_management/save_setting_project",
      data: {
      ...
      success: function (response) {
        if (response.status == "success") {
          ...
          loadDataSettingProject();
          success("These project save successfully.");
        }else if (response.status == "exist") {
          $(".error-project").remove();
          $(".project-name").after('<span class="error-project">Name already exsit</span>');
        }else {
          fails("Fails!!!.")
        }
      }
...
$(document).on("click", ".btn-save-role", function () {
  ...
  if ($(".role-name").val().length < 1) {
    $(".role-name").after('<span class="error-role">Please enter Role Name</span>');
  }

  if ($(".error-role").length == 0) {
    $.ajax({
      type: "POST",
      url: "/category_management/save_setting_role",
      data: {
        role_id: $(".role-id").val(),
      ...
      success: function (response) {
        if (response.status == "success") {
          ...
          loadDataSettingRole();
          success("These role save successfully.");
        }else if (response.status == "exist") {
          $(".error-role").remove();
          $(".role-name").after('<span class="error-role">Name already exsit</span>');
        }else {
          fails("Fails!!!.")
        }
      }
...
$(document).on("click", ".btn-save-title", function () {
  ...
  if ($(".title-role-name").val().length < 1) {
    $(".title-role-name").after('<span class="error-title">Please enter Role Name</span>');
  }
  if ($(".title-name").val().length < 1) {
    $(".title-name").after('<span class="error-title">Please enter Title Name</span>');
  }
  if ($(".title-code").val().length < 1) {
    $(".title-name").after('<span class="error-title">Please enter Title Code</span>');
  }
  if ($(".title-rank").val().length < 1) {
    $(".title-rank").after('<span class="error-title">Please enter Rank</span>');
  }else if($(".title-rank").val().length > 10) {
    $(".title-rank").after('<span class="error-title">Please enter Rank less than 10</span>');
  }

  if ($(".error-title").length == 0) {
    $.ajax({
      type: "POST",
      url: "/category_management/save_setting_title",
      data: {
      ...
      success: function (response) {
        if (response.status == "success") {
          ...
          loadDataSettingTitle();
          success("These title save successfully.");
        }else if (response.status == "exist") {
          $(".error-title").remove();
          $(".company-name").after('<span class="error-title">Name already exsit</span>');
        }else {
          fails("Fails!!!.")
        }
      }
...
$(document).on("click", ".status_icon_company", function () {
  company_id = $(this).data("company_id");
  $.ajax({
    url: "/category_management/status_setting_company",
    type: "POST",
    headers: {
      "X-CSRF-Token": $('meta[name="csrf-token"]').attr("content")
    },
    ...
    success: function (response) {
      if (response.status == "success") {
        if (response.change == false) {
          $('a.status_icon_company[data-company_id="' + company_id + '"]').html(
...
$(document).on("click", ".status_icon_project", function () {
  project_id = $(this).data("project_id");
  $.ajax({
    url: "/category_management/status_setting_project",
    type: "POST",
    headers: {
      "X-CSRF-Token": $('meta[name="csrf-token"]').attr("content")
    },
    ...
    success: function (response) {
      if (response.status == "success") {
        if (response.change == false) {
          $('a.status_icon_project[data-project_id="' + project_id + '"]').html(
            '<i class="fa fa-toggle-off"></i>'
          );
        } else {
          $('a.status_icon_project[data-project_id="' + project_id + '"]').html(
...
$(document).on("click", ".status_icon_role", function () {
  role_id = $(this).data("role_id");
  $.ajax({
    url: "/category_management/status_setting_role",
    type: "POST",
    headers: {
      "X-CSRF-Token": $('meta[name="csrf-token"]').attr("content")
    },
    ...
    success: function (response) {
      if (response.status == "success") {
        if (response.change == false) {
          $('a.status_icon_role[data-role_id="' + role_id + '"]').html(
            '<i class="fa fa-toggle-off"></i>'
          );
        } else {
          $('a.status_icon_role[data-role_id="' + role_id + '"]').html(
...
$(document).on("click", ".status_icon_title", function () {
  title_id = $(this).data("title_id");
  $.ajax({
    url: "/category_management/status_setting_title",
    type: "POST",
    headers: {
      "X-CSRF-Token": $('meta[name="csrf-token"]').attr("content")
    },
    ...
    success: function (response) {
      if (response.status == "success") {
        if (response.change == false) {
          $('a.status_icon_title[data-title_id="' + title_id + '"]').html(
            '<i class="fa fa-toggle-off"></i>'
          );
        } else {
          $('a.status_icon_title[data-title_id="' + title_id + '"]').html(
...
function setDisplay(id, id_header, add_class, save_class) {
  ...
  $("#btn_add").removeClass("btn-add-company btn-add-project btn-add-role btn-add-title");
...
function appendDataToTableCompany(data) {
  ...
  data.forEach(function (user, i) {
    ...
    if (user.status)
      tpl += `
              <a class="action_icon status_icon_company" title="Disable/Enable company" data-company_id="{id}" href="javascript:;">
              <i class="fa fa-toggle-on"></i>
    ...
    tpl += `
        <tr>
          ...
          <td class="type-icon item-row action">
            ...
            <i class="fa fa-file-code-o" aria-hidden="true" title="edit"></i>
            </a>`.formatUnicorn({ number: i + 1, id: user.id, name: user.name, abbreviation: user.abbreviation, description: user.description, note: user.note });
    if (user.status)
      tpl += `
                    <a class="action_icon status_icon_role" title="Disable/Enable role" data-role_id="{id}" href="javascript:;">
                    <i class="fa fa-toggle-on"></i>
                    </a>`.formatUnicorn({ id: user.id })
    else
      tpl += `
    ...
    tpl += `
        <tr>
          ...
          <td class="type-icon item-row action">
            ...
            <i class="fa fa-file-code-o" aria-hidden="true" title="edit"></i>
            </a>`.formatUnicorn({ number: i + 1, id: user.id, role_id: user.role_id, role_name: user.role_name, name: user.name, abbreviation: user.desc, rank: user.rank, description: user.description, note: user.note, code: user.code });
    if (user.status)
      tpl += `
                    <a class="action_icon status_icon_title" title="Disable/Enable title" data-title_id="{id}" href="javascript:;">
                    <i class="fa fa-toggle-on"></i>
                    </a>`.formatUnicorn({ id: user.id })
    else
      tpl += `
...
function loadRoleName(data_filter = {}) {
  $.ajax({
    url: "/category_management/data_setting_load_role",
    data: data_filter,
    type: "POST",
    headers: {
      "X-CSRF-Token": $('meta[name="csrf-token"]').attr("content")
