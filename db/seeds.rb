...
User.create!(id: 1, email: "admin@bestarion.com", password: "password", password_confirmation: "password", first_name: "admin", last_name: "admin", account: "admin", role_id: "1", company_id: 3, joined_date: rand(12).years.ago, gender: rand(2), title_id: rand(1..3)) if Rails.env.development?
User.create!(id: 2, email: "duynt@bestarion.com", password: "password", password_confirmation: "password", first_name: "Duy", last_name: "Nguyen Thanh", account: "duynt", role_id: "1", company_id: 3, joined_date: rand(12).years.ago, gender: rand(2), title_id: rand(1..3))
...
User.create!(id: 8, email: "phungnguyenvan@bestarion.com", password: "password", password_confirmation: "password", first_name: "Phung", last_name: "Nguyen Van", account: "phungnv", role_id: "1", company_id: "2", joined_date: rand(12).years.ago, gender: rand(2), title_id: rand(1..3))
...
User.create!(id: 14, email: "linhnguyenquang@bestarion.com", password: "password", password_confirmation: "password", first_name: "Linh", last_name: "Nguyen Quang", account: "linhnq", role_id: "1", company_id: "3", joined_date: rand(12).years.ago, gender: rand(2), title_id: rand(1..3))
...
User.create!(id: 20, email: "lydothi@bestarion.com", password: "password", password_confirmation: "password", first_name: "Ly", last_name: "Do Thi", account: "lydt", role_id: "1", company_id: "4", joined_date: rand(12).years.ago, gender: rand(2), title_id: rand(1..3))
